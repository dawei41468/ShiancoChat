  ...
  return (
    <div className={`flex-1 overflow-y-auto overscroll-y-contain p-8 transition-colors duration-300 ${isDarkMode ? 'dark-theme-bg text-dark-text-light' : 'bg-white text-gray-900'}`}>
      <div className="max-w-3xl mx-auto">
        <h1 className={`text-4xl font-extrabold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{t.tutorialsTitle || "Tutorials"}</h1>
        ...
        <section className="mb-10">
          <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{t.quickStartTitle || "Quick Start"}</h2>
        ...
        <section className="mb-10">
          <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{t.recommendedUseCasesTitle || "Recommended Use Cases"}</h2>
          <ul className={`list-disc list-inside space-y-2 ${isDarkMode ? 'text-dark-text-dark' : 'text-gray-700'}`}>
        ...
        <section>
          <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{t.examplePromptsTitle || "Example Prompts"}</h2>
