...
const translations = {
  EN: {
    ...
    signOut: "Sign Out",
    // Assistants + department knowledge spaces
    assistantsTitle: "AI Assistants",
    assistants: "Assistants",
    clearAssistant: "Clear assistant",
    departmentBadge: "Dept",
    spaceScope: "Space scope",
    scopeUser: "Personal",
    scopeDepartment: "Department",
    departmentLabel: "Department",
    deptSpaceHint: "Shared with all members of the department",
    createAssistant: "Create Assistant",
    assistantName: "Assistant",
    assistantNameEn: "Name (EN)",
    assistantNameZh: "Name (ZH)",
    assistantDescEn: "Description (EN)",
    assistantDescZh: "Description (ZH)",
    globalAssistant: "Global (all departments)",
    ...
    assistantCreatedSuccess: "Assistant {name} created.",
    assistantDeletedSuccess: "Assistant {name} deleted.",
    deleteAssistant: "Delete Assistant",
    deleteAssistantConfirm: "Delete assistant {name}? This cannot be undone.",
    saving: "Saving..."
  },
  CN: {
    appTitle: "ShiancoChat",
    ...
    scopeDepartment: "部门",
    departmentLabel: "部门",
    deptSpaceHint: "与部门所有成员共享",
    createAssistant: "创建助手",
    assistantName: "助手",
    assistantNameEn: "名称（英文）",
    assistantNameZh: "名称（中文）",
    assistantDescEn: "描述（英文）",
    assistantDescZh: "描述（中文）",
    globalAssistant: "全局（所有部门）",
    systemPrompt: "系统提示词",
    outputTemplate: "输出模板（可选）",
    enabledLabel: "启用",
    modelPolicy: "模型策略",
    loadingAssistants: "加载助手中...",
    noAssistantsFound: "未找到助手",
    assistantCreatedSuccess: "助手 {name} 已创建。",
    assistantDeletedSuccess: "助手 {name} 已删除。",
    deleteAssistant: "删除助手",
    deleteAssistantConfirm: "确定要删除助手 {name} 吗？此操作无法撤销。",
    saving: "保存中...",
    // Tutorials Page
    tutorialsTitle: "教程",
