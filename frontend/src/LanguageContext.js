...
const translations = {
  EN: {
    ...
    user: "User",
    admin: "Admin",
    chatSettingsPlaceholder: "Chat settings content will appear here.",
    adminSettingsPlaceholder: "Admin settings content will appear here.",
    userDeletedSuccess: "User {username} deleted successfully.",
    roleUpdatedSuccess: "User role updated to {role}",
